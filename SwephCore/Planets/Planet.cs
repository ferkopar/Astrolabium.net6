...
namespace SwephCore.Planets
{
    ...
    public struct Planet
    {
        ...
        public static Planet Eros = FirstAsteroid + 433;
        ...
        /// This id is a planet ?
        /// </summary>
        public bool IsPlanet => Id >= 0 && Id <= LastPlanet;

        /// <summary>
        /// This id is a fictitious ?
        /// </summary>
        public bool IsFictitious => Id >= FirstFictitious && Id < FirstComet;

        /// <summary>
        /// This id is a comet ?
        /// </summary>
        public bool IsComet => Id >= FirstComet && Id < FirstAsteroid;

        /// <summary>
        /// This id is an asteroid ?
        /// </summary>
        public bool IsAsteroid => Id >= FirstAsteroid;
    }
}
