...
namespace SwissEphCore.CPort
{
    ...
    static class SwemTab
    {
        ...
        */
        static double[] mertabl = new double[]{
      ...
      -82471.79425,       18615.92342,
       ...
       -3909.34957,       -9646.69156,
        ...
        static double[] mertabb = new double[]{
      ...
      -18160.57888,       16010.48165,
       ...
       -3991.04809,       -2886.97750,
        ...
        static double[] mertabr = new double[]{
       ...
       -9066.27933,      -40747.62807,
        ...
        static sbyte[] merargs = new sbyte[] {
              0,  3,
              3,  1,  1,-10,  3, 11,  4,  0,
              2,  2,  5, -5,  6,  2,
              3,  5,  1,-14,  2,  2,  3,  1,
        ...
        public static Sweph.plantbl mer404 = new Sweph.plantbl(
         new sbyte[] { 11, 14, 10, 11, 4, 5, 2, 0, 0, },
         6,
         merargs,
         mertabl,
         mertabb,
        ...
        */
        static double[] ventabl = new double[]{
        ...
        static double[] ventabb = new double[] {
        ...
        static double[] ventabr = new double[] {
        ...
        static sbyte[] venargs = new sbyte[]{
  0,  3,
  2,  2,  5, -5,  6,  0,
  3,  2,  2,  1,  3, -8,  4,  0,
  3,  5,  1,-14,  2,  2,  3,  0,
 ...
 -1
        ...
        public static Sweph.plantbl ven404 = new Sweph.plantbl(
             new sbyte[] { 5, 14, 13, 8, 4, 5, 1, 0, 0, },
             5,
             venargs,
             ventabl,
             ventabb,
        ...
        */
        ...
        static double[] eartabl = new double[]{
       ...
       -6717.66079,       -1543.17403,
        ...
        static double[] eartabb = new double[]{
       ...
       -1941.10461,         508.68393,        -419.80123,       -4679.60117,
        ...
        static double[] eartabr = new double[]{
        ...
        static sbyte[] earargs = new sbyte[]{
  0,  3,
  3,  4,  3, -8,  4,  3,  5,  2,
  2,  2,  5, -5,  6,  1,
  3,  2,  2,  1,  3, -8,  4,  0,
 ...
 -1
        ...
        public static Sweph.plantbl ear404 = new Sweph.plantbl(
         new sbyte[] { 1, 9, 14, 17, 5, 5, 2, 1, 0, },
         4,
         earargs,
         eartabl,
         eartabb,
        ...
        */
        ...
        static double[] martabl = new double[] {
     ...
     1279543.73631,
      ...
      -25743.89874,       15506.87748,       15609.59853,       35173.63133,
       ...
       -2255.81376,       -1309.01028,       -2025.69590,        2774.69901,
        ...
        static double[] martabb = new double[] {
        ...
        static double[] martabr = new double[] {
       ...
       -7685.78246,      -12789.43898,      -17474.50562,        7757.84703,
        ...
        static sbyte[] marargs = new sbyte[]{
  0,  4,
  3,  4,  3, -8,  4,  3,  5,  2,
  3,  5,  2, -6,  3, -4,  4,  0,
  2,  2,  5, -5,  6,  1,
 ...
 -1
        ...
        public static Sweph.plantbl mar404 = new Sweph.plantbl(
         new sbyte[] { 0, 5, 12, 24, 9, 7, 3, 2, 0, },
         5,
         marargs,
         martabl,
         martabb,
        ...
        */
        static double[] juptabl = new double[] {
      153429.13855,      130818.16897,       18120.42948,       -8463.12663,
       ...
       -8960.81693,        4663.55087,       -4947.61530,       19377.42027,
        ...
        static double[] juptabb = new double[] {
       ...
       -1187.61854,       -1094.91786,       -1011.21939,       -1102.25998,
        ...
        static double[] juptabr = new double[] {
       ...
       -2325.87639,       -4476.46256,       -9683.77583,       -2472.92565,
        ...
        static sbyte[] jupargs = new sbyte[]{
  0,  6,
  3,  2,  5, -6,  6,  3,  7,  0,
  2,  2,  5, -5,  6,  6,
  3,  1,  5, -2,  6, -3,  8,  0,
 ...
 -1
        ...
        public static Sweph.plantbl jup404 = new Sweph.plantbl(
         new sbyte[] { 0, 0, 1, 0, 9, 16, 7, 5, 0, },
         6,
         jupargs,
         juptabl,
         juptabb,
        ...
        */
        public static double[] sattabl = new double[] {
     1788381.26240,     2460423.68044,     1370113.15868,      415406.99187,
      ...
      -16403.69351,       29602.70098,       14672.06363,       16234.17489,
       ...
       -1058.13125,        4095.02368,       -2793.78506,        1381.93282,
        ...
        static double[] sattabb = new double[] {
     -567865.62548,     -796277.29029,     -410804.00791,      -91793.12562,
      ...
      -13758.97795,        4807.62301,      -14582.14552,        9019.73021,
       ...
       -2476.87148,       -1880.58197,        -574.49433,         227.45615,
        ...
        static double[] sattabr = new double[] {
      ...
      -17268.46134,        1144.22336,      -16658.48585,        5252.94094,
       -3461.47865,        2910.56452,        -433.49442,        -305.74268,
        ...
        static sbyte[] satargs = new sbyte[]{
  0,  7,
  3,  2,  5, -6,  6,  3,  7,  0,
  2,  2,  5, -5,  6,  5,
  3,  1,  6, -4,  7,  2,  8,  0,
 ...
 -1
        ...
        public static Sweph.plantbl sat404 = new Sweph.plantbl(
         new sbyte[] { 0, 0, 1, 0, 8, 18, 9, 5, 0, },
         7,
         satargs,
         sattabl,
         sattabb,
        ...
        */
        static double[] uratabl = new double[] {
     ...
     -313205.95341,     1462242.64616,      112982.53079,     1865690.41965,
      308844.30901,      639864.93227,       89716.32843,       10378.80773,
        ...
        static double[] uratabb = new double[] {
      ...
      142710.47871,      -96584.83892,      145395.05981,      -86630.96423,
       ...
       -4077.02379,        -353.39110,       -2781.63273,         -75.23318,
        ...
        static double[] uratabr = new double[] {
     ...
     -288441.70339,      150227.25291,       -2500.57537,       42676.19888,
       ...
       -4126.00409,        -828.73564,       -2801.35204,       -2293.77751,
        ...
        static sbyte[] uraargs = new sbyte[]{
  0,  3,
  2,  1,  7, -2,  8,  0,
  2,  2,  7, -4,  8,  0,
  2,  3,  7, -6,  8,  1,
 ...
 -1
        ...
        public static Sweph.plantbl ura404 = new Sweph.plantbl(
         new sbyte[] { 0, 0, 0, 0, 5, 10, 9, 12, 0, },
         6,
         uraargs,
         uratabl,
         uratabb,
        ...
        */
        static double[] neptabl = new double[] {
       ...
       -2759.81719,        2476.20912,
        ...
        static double[] neptabb = new double[] {
       ...
       -4749.41359,       -4244.46820,
        ...
        static double[] neptabr = new double[] {
       ...
       -1237.19769,       -1379.88864,
        ...
        static sbyte[] nepargs = new sbyte[] {
  0,  3,
  2,  1,  7, -2,  8,  0,
  3,  3,  5, -8,  6,  3,  8,  0,
  2,  2,  7, -4,  8,  0,
 ...
 -1
        ...
        public static Sweph.plantbl nep404 = new Sweph.plantbl(
         new sbyte[] { 0, 0, 0, 0, 3, 8, 7, 9, 0, },
         3,
         nepargs,
         neptabl,
         neptabb,
        ...
        */
        static double[] plutabl = new double[] {
     ...
     -143760.57524,      104182.01134,      -17313.30132,       12591.15513,
      ...
      -10128.69894,        4535.32148,         281.75353,        -218.49194,
       ...
       -1177.36865,        -501.06937,         166.14792,        -103.36431,
        ...
        static double[] plutabb = new double[] {
     ...
     -226588.37473,     -121017.23944,      -48472.25935,      -74195.36778,
      ...
      174386.39024,      158048.26273,      159192.81681,      220154.55148,
       ...
       26475.02580,       35363.04345,       19877.11475,       41430.35940,
        ...
        static double[] plutabr = new double[] {
     ...
     -553911.89340,      274748.95145,     -122250.71547,       56608.95768,
      ...
      -13352.09393,        7461.71279,       -2609.33578,         726.50321,
       ...
       15486.28190,        8747.74091,        2455.51737,        3839.83609,
        ...
        static sbyte[] pluargs = new sbyte[]{
  0,  7,
  2,  3,  7, -9,  9,  0,
  2,  4,  7,-12,  9,  0,
  2,  4,  7, -8,  8,  0,
 ...
 -1
        ...
        public static Sweph.plantbl plu404 = new Sweph.plantbl(
         new sbyte[] { 0, 0, 0, 0, 2, 2, 9, 13, 13, },
         7,
         pluargs,
         plutabl,
         plutabb,
