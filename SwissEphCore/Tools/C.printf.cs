...
namespace SwissEphCore.Tools
{
    /// <summary>
    /// printf implementation from http://www.codeproject.com/Articles/19274/A-printf-implementation-in-C
    /// </summary>
    partial class C
    {
        ...
        public static void fprintf(TextWriter Destination, string Format, params object[] Parameters) {
            Destination.Write(C.sprintf(Format, Parameters));
        }
        #endregion
        #region sprintf
