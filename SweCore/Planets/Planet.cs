...
namespace SweCore.Planets
{
    ...
    public struct Planet
    {
        ...
        public static readonly Planet Eros = FirstAsteroid + 433;
        public static readonly Planet Sappho = FirstAsteroid + 80;
        public static readonly Planet Psyhe = FirstAsteroid + 16;
        ...
        public string GetPlanetString() => PlanetHelper.GetPlanetString(this);

        public string GetPlanetName() => PlanetHelper.GetPlanetName(this);

        /// <summary>
        /// String value
        /// </summary>
        public override string ToString() => $"{Id.ToString()} {PlanetHelper.GetPlanetName(this)} ";
        ...
        public string DisplayCharacter => PlanetHelper.GetPlanetString(this);
        public string DisplayName => PlanetHelper.GetPlanetName(this);
